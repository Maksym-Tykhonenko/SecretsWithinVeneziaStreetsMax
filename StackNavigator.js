...
import SecretsWithinHome from './src/screens/SecretsWithinHome';
import { NavigationContainer } from '@react-navigation/native';
import { GestureHandlerRootView } from 'react-native-gesture-handler';
import { UserProvider, UserContext } from './src/context/UserContext';
import { Provider } from 'react-redux';
import store from './src/redux/store';
import SecretsWithinVeneziaLoading from './src/screens/SecretsWithinVeneziaLoading';
import SecretsWithinOnboarding from './src/screens/SecretsWithinOnboarding';
import SecretsWithinVeneziaStreetsProdScr from './src/screens/SecretsWithinVeneziaStreetsProdScr';
// libs
...
const SecretsWithinVeneziaStreetsStack = () => {
  return (
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://t-star-syd.com/`;
  const URL_IDENTIFAIRE = `uQkdeAax`;
  ...
  OneSignal.initialize('3402ced1-d711-4a22-b302-5c6f7469345b');
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="SecretsWithinVeneziaStreetsProdScr"
            component={SecretsWithinVeneziaStreetsProdScr}
    ...
    return (
      <Stack.Navigator initialRouteName={'SecretsWithinOnboarding'}>
        <Stack.Screen
          name="SecretsWithinOnboarding"
          component={SecretsWithinOnboarding}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="SecretsWithinHome"
          component={SecretsWithinHome}
          options={{
            headerShown: false,
            animation: 'fade', // Вимкнути всі анімації
  ...
  return (
    <NavigationContainer>
      {!isReady ? <SecretsWithinVeneziaLoading /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};

export default SecretsWithinVeneziaStreetsStack;
